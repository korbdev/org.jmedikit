...
public class DicomCanvas extends Canvas{
	...
	private Listener paintListener = new Listener() {
		...
		public void handleEvent(Event event) {
			...
			// bringt die Bilddaten auf eine einheitliche Größe
			// Sei Bildstapel (x, y, z) => (512, 512, 22) 
			// dann haben Bilddaten in Coronaler/Sagittaler Ansicht eine Größe von (512, 22, 512)
			// dadurch muss das Bild 512 x 22 auf ursprüngliche Größe von 512 x 512 skaliert werden
